...
// const FilterForm = ({ originalData, form, setFilteredData }) => {
//   return (
//     <Form
//       form={form}
//       layout="vertical"
...
//         <Select mode="multiple" placeholder="Select" showSearch>
//           {originalData.map((item) => (
//             <Select.Option key={item.orgName} value={item.orgName}>
//               {item.orgName}
//             </Select.Option>
...
//       <div >
//         <Form.Item>
//           {/* <Button onClick={() => form.resetFields()} className={styles.reset}> */}
